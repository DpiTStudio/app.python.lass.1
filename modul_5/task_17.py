...
# 
print('Почтовое отделение работает по графику с 08:00 до 22:00.', '\n', 'С 14:00 до 15:00 сотрудники уходят на обед', '\n', 'Машина с почтой приезжает в 10:00 и 18:00.', sep='')
timing = int(input('Введите время: '))
if (timing >= 8 and timing < 10) or (timing >= 12 and timing < 14) or (timing >= 15 and timing < 18) or (timing >= 20 and timing < 22):
